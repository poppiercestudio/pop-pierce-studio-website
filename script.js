...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Formulario de reseñas encontrado:', reviewForm);
    ...
    if (reviewForm) {
        ...
        reviewForm.addEventListener('submit', function(e) {
            ...
            if (isSubmittingReview) {
                console.log('Formulario de reseña ya se está enviando...');
                return;
            }
            ...
            console.log('Datos de la reseña:', { name, rating, text });
            
            // Validación básica
            if (!name || !rating || !text) {
                showNotification('Por favor, completa todos los campos de la reseña.', 'error');
            ...
            // Agregar al contenedor de reseñas
                ...
                <div class="reviewer-info">
                    ...
                    <div class="reviewer-details">
                        ...
                        <div class="review-rating">
                            ...
                            <span class="rating-text">${ratingTexts[rating]}</span>
                        </div>
                    </div>
                </div>
                <div class="review-date">Ahora</div>
            </div>
